...
import com.happiness.githerbs.domain.member.dto.response.KakaoLogoutResponseDto;
...
public interface KakaoUserClient {
	...
	public KakaoLogoutResponseDto logoutClient(@RequestHeader("Authorization") String accessToken);
